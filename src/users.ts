...
//should add tag entity+update the user contract (can't use string[])
// export function handleAddTag(event: AddTagEvent): void {
//   let entity = User.load(event.params._userAddress.toString())
//   if (entity !== null) {
...
export function handleSignup(event: SignupEvent): void {
  let entity = newUser(event.params._userAddress.toString());
